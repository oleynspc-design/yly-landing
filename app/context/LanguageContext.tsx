...
export const translations = {
  pl: {
    ...
    offer: {
      ...
      sub: "Od kursów wideo po ekskluzywne grupy — mamy narzędzia, które przyspieszą Twój rozwój w świecie AI.",
      items: [
        {
          tag: "Bestseller",
          title: "Kursy AI",
          desc: "Inżynieria Promptów, Automatyzacja AI — profesjonalne kursy wideo z egzaminem i certyfikatem.",
          price: "od 199 zł",
          cta: "Kup kurs",
        },
        {
          tag: "Popularny",
          title: "E-book: Prompty dla Biznesu",
          desc: "100+ profesjonalnych promptów do zastosowań biznesowych — marketing, sprzedaż, analityka, HR.",
          price: "49 zł",
          cta: "Kup e-book",
        },
        {
          tag: "Nowy",
          title: "Kolekcja Promptów PRO",
          desc: "200+ przetestowanych promptów do ChatGPT, Claude, Midjourney, DALL-E i innych narzędzi AI.",
          price: "79 zł",
          cta: "Kup prompty",
        },
        {
          tag: "Premium",
          title: "Pakiet Kompletny YLY",
          desc: "Wszystkie kursy + e-booki + kolekcje promptów + społeczność premium. Najlepsza wartość — oszczędzasz ponad 40%!",
          price: "399 zł",
          cta: "Kup pakiet",
        },
      ],
  ...
  en: {
    ...
    offer: {
      ...
      sub: "From video courses to exclusive groups — we have the tools to accelerate your growth in the AI world.",
      items: [
        {
          tag: "Bestseller",
          title: "AI Courses",
          desc: "Prompt Engineering, AI Automation — professional video courses with exams and certificates.",
          price: "from 199 PLN",
          cta: "Buy Course",
        },
        {
          tag: "Popular",
          title: "E-book: Business Prompts",
          desc: "100+ professional prompts for business — marketing, sales, analytics, HR.",
          price: "49 PLN",
          cta: "Buy E-book",
        },
        {
          tag: "New",
          title: "PRO Prompt Collection",
          desc: "200+ tested prompts for ChatGPT, Claude, Midjourney, DALL-E and other AI tools.",
          price: "79 PLN",
          cta: "Buy Prompts",
        },
        {
          tag: "Premium",
          title: "YLY Complete Bundle",
          desc: "All courses + e-books + prompt collections + premium community. Best value — save over 40%!",
          price: "399 PLN",
          cta: "Buy Bundle",
        },
      ],
  ...
  uk: {
    ...
    offer: {
      ...
      title: "Все, що тобі потрібно",
      sub: "Від відеокурсів до ексклюзивних груп — у нас є інструменти для прискорення твого розвитку у світі ШІ.",
      items: [
        {
          tag: "Бестселер",
          title: "Курси ШІ",
          desc: "Інжиніринг промптів, автоматизація ШІ — професійні відеокурси з іспитами та сертифікатами.",
          price: "від 199 PLN",
          cta: "Купити курс",
        },
        {
          tag: "Популярний",
          title: "E-book: Промпти для бізнесу",
          desc: "100+ професійних промптів для бізнесу — маркетинг, продажі, аналітика, HR.",
          price: "49 PLN",
          cta: "Купити e-book",
        },
        {
          tag: "Новий",
          title: "Колекція промптів PRO",
          desc: "200+ протестованих промптів для ChatGPT, Claude, Midjourney, DALL-E та інших інструментів ШІ.",
          price: "79 PLN",
          cta: "Купити промпти",
        },
        {
          tag: "Преміум",
          title: "Повний пакет YLY",
          desc: "Усі курси + e-книги + колекції промптів + преміум-спільнота. Найкраща вигода — економія понад 40%!",
          price: "399 PLN",
          cta: "Купити пакет",
        },
      ],
  ...
  es: {
    ...
    offer: {
      ...
      sub: "Desde cursos en vídeo hasta grupos exclusivos — tenemos las herramientas para acelerar tu crecimiento en el mundo de la IA.",
      items: [
        {
          tag: "Bestseller",
          title: "Cursos de IA",
          desc: "Ingeniería de Prompts, Automatización IA — cursos en vídeo profesionales con exámenes y certificados.",
          price: "desde 199 PLN",
          cta: "Comprar Curso",
        },
        {
          tag: "Popular",
          title: "E-book: Prompts para Negocios",
          desc: "100+ prompts profesionales para negocios — marketing, ventas, analítica, RRHH.",
          price: "49 PLN",
          cta: "Comprar E-book",
        },
        {
          tag: "Nuevo",
          title: "Colección de Prompts PRO",
          desc: "200+ prompts probados para ChatGPT, Claude, Midjourney, DALL-E y otras herramientas de IA.",
          price: "79 PLN",
          cta: "Comprar Prompts",
        },
        {
          tag: "Premium",
          title: "Paquete Completo YLY",
          desc: "Todos los cursos + e-books + colecciones de prompts + comunidad premium. ¡Mejor valor — ahorra más del 40%!",
          price: "399 PLN",
          cta: "Comprar Paquete",
        },
      ],
