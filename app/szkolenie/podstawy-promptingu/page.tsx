...
export default function PodstawyPromptinguPage() {
        ...
        <div className="max-w-5xl mx-auto px-4 py-16">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-4xl font-black text-white">Inżynieria Promptów</h1>
                <p className="text-gray-500 text-sm mt-1">Pełny program nauczania · 4 Semestry · 10 Lekcji · Egzamin 40 pytań</p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-3 mt-6 mb-12">
              ...
              <span className="px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs font-medium">40 pytań egzaminacyjnych</span>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mt-12">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-white font-bold text-lg">Egzamin Końcowy — 40 pytań</h3>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            {!quizSubmitted && (
              <>
                ...
                <p className="text-gray-400 mb-4">
                  {quizQuestions.length} pytań · Próg certyfikatu: 32/{quizQuestions.length} · Strona {quizPage + 1}/{totalQuizPages}
                </p>
            ...
            {quizSubmitted ? (
              <motion.div initial={{ opacity: 0, y: 30, scale: 0.95 }} animate={{ opacity: 1, y: 0, scale: 1 }} className="text-center">
                <Trophy size={80} className={`mx-auto mb-6 ${calculateScore() >= 32 ? "text-yellow-400" : "text-gray-500"}`} />
                ...
                <div className="text-xl font-medium mb-10">
                  {calculateScore() >= 32
                    ? <span className="text-green-400">Gratulacje! Certyfikat Inżynierii Promptów odblokowany! 🏆</span>
                    : calculateScore() >= 20
